...
export const Faqs = () => {
  return (
   ...
   <div className='container'>
        ...
        <div className='flex gap-[50px] mb-[64px]' > 
            <h2 className='text-[40px] text-[#495567] font-bold leading-12'>How it works</h2>
            <div>


                <div className='py-[32px] px-[40px] bg-[#F2F5F9] w-[730px]'>
                ...
                <div className='flex justify-between py-[32px] px-[40px] bg-[#F2F5F9] my-[20px]'>
                    <h2 className='text-[24px] font-bold leading-7'>Can I find a nearby Scoots?</h2>
                    <img src={faq_icon_two} alt="" />
                </div>
                <div className='flex justify-between py-[32px] px-[40px] bg-[#F2F5F9] '>
        ...
        <div className='flex gap-[70px] mb-[64px]' > 
            <h2 className='text-[40px] text-[#495567] font-bold leading-12'>Safe driving</h2>
            <div>
    ...
    <img src={faq_round} alt=""  className='absolute bottom-[50px] w-[150px]'/>
    </div>
