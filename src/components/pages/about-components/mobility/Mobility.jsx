  ...
  return (
    <div className='relative '>
      <div className='container'>
           <div className=' lg:justify-between my-[150px] md:flex md:flex-col-reverse lg:flex-row '>
        <div className='py-[100px] '>
        <h2 className='text-[48px]  text-[#495567]  font-bold leading-12 md:text-center  lg:text-start'>
        Mobility for the <br />
         digital era  
        </h2>
        <p className='mt-[20px]  text-[#939CAA]  text-[15px] font-normal leading-7 md:text-center lg:text-start'>
        Getting around should be simple (and even fun!) for <br />
         ...
         <div>
          <img src={mobility_one_img} alt=""  className='rounded-[50%] md:ml-[150px] lg:ml-0'/>
         </div>
 
           </div>
           <div className='lg:flex lg:justify-between mb-[100px] lg:flex-row'>
          <div>
          <img src={mobility_two_img} alt=""  className='rounded-[50%] md:ml-[150px] lg:ml-0'/>
         </div>
        <div className='py-[100px] '>
        <h2 className='text-[48px]  text-[#495567]  font-bold leading-12 md:text-center lg:text-start'>
        Better urban <br />
        ...
        <img src={mobility_round_two} alt=""  className='absolute bottom-[100px] md:bottom-[450px] lg:bottom-0'/>
        <img src={mobility_one_icon} alt="" className='absolute top-[270px] right-0'/>
        <img src={mobility_two_icon} alt=""  className='absolute  md:bottom-[750px] lg:bottom-[300px] '/>
    </div>
