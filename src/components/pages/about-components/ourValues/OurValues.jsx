...
export const  OurValues = () => {
  return (
    <div className='relative'>
      ...
      <h2 className='text-center text-[48px] font-bold leading-12 text-[#495567] mb-[85px] max-sm:text-center dark:text-white'>Our values</h2>
      <div className='lg:flex gap-[72px]'>
         <div className='md:mb-[50px]'>
         <div className='relative left-[40px] '>
          <img src={our_one_img} alt="" className='rounded-[50%] md:ml-[220px] lg:ml-0 max-sm:ml-[170px]'/>
          <img src={our_one_icon} alt="" className='absolute bottom-[-55px] left-[70px] md:ml-[225px] lg:ml-0 max-sm:ml-[170px]'  />
         </div>
         <h3 className='text-[24px] font-bold leading-7 text-center mt-[92px] mb-[27px] text-[#495567] max-sm:text-center dark:text-white '>Our tech</h3>
         <p className='text-center text-[15px] font-normal leading-7 text-[#939CAA] max-sm:text-center dark:text-white'>
        ...
        <div  className='md:mb-[50px] max-sm:my-[100px]'>
         <div className='relative left-[40px]'>
          <img src={our_two_img} alt="" className='rounded-[50%] md:ml-[220px] lg:ml-0 max-sm:ml-[170px]'/>
          <img src={our_two_icon} alt="" className='absolute bottom-[-55px] left-[70px] md:ml-[225px] lg:ml-0 max-sm:ml-[170px]'  />
         </div>
       ...
       <div>
         <div className='relative left-[40px]'>
          <img src={our_three_img} alt="" className='rounded-[50%] md:ml-[220px] lg:ml-0 max-sm:ml-[170px]'/>
          <img src={our_three_icon} alt="" className='absolute bottom-[-55px] left-[70px] md:ml-[225px] lg:ml-0 max-sm:ml-[170px]'  />
         </div>
    ...
    <img src={our_round} alt=""  className='absolute top-[-250px] max-sm:hidden '/>
    </div>
