...
export const OurValues = () => {
  return (
    <div className='relative'>
      ...
      <h2 className='text-center text-[48px] font-bold leading-12 text-[#495567] mb-[85px] max-sm:text-center'>Our values</h2>
      <div className='lg:flex gap-[72px]'>
         ...
         <h3 className='text-[24px] font-bold leading-7 text-center mt-[92px] mb-[27px] text-[#495567] max-sm:text-center '>Our tech</h3>
         <p className='text-center text-[15px] font-normal leading-7 text-[#939CAA] max-sm:text-center'>
