  ...
  return (
    <div className='container mb-[120px]'>
        <div className='lg:flex lg:justify-between'>
          <h1 className='text-[48px]  text-[#495567] font-bold leading-12 md:text-center max-sm:text-center '>  Your city <br /> not listed?</h1>
             <p className='text-[#939CAA] text-[18px] font-normal leading-8 md:text-center md:my-[50px] max-sm:text-center max-sm:px-[3px] max-sm:py-[32px]'>
