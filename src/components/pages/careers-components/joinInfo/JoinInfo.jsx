...
export const JoinInfo = () => {
  return (
    <div className='container  mb-[140px]'>
      <div className='py-[35px] px-[40px] bg-[#F2F5F9]  flex justify-between'>
      <div>
      ...
      <div className='py-[35px] px-[40px] bg-[#F2F5F9]  flex justify-between my-[24px]'>
      <div>
      ...
      <div>
       ...
       <div className='py-[35px] px-[40px] bg-[#F2F5F9]  flex justify-between mb-[24px]'>
      <div>
