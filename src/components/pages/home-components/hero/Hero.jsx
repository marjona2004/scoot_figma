  ...
  return (
    <div className="relative   lg:bg-[url('/public/mock-image/hero_img/bg.png')]  md:bg-[url('/public/mock-image/hero_img/bg.png')]  lg:bg-cover  md:pb-[100px]">
        <div className='container md:py-[163px] lg:py-[163px]  '>
              <h1 className='text-[56px] lg:font-bold leading-11 text-white lg:text-start  md:text-center '>
              Scooter sharing <br /> made simple
              </h1>
              <p className='lg:py-[40px] lg:pl-[95px] lg:leading-6 md:py-[40px] text-white md:text-center  lg:text-start'>
         ...
         <img src={header_img_line_one} alt="" className='lg:absolute lg:top-[410px] lg:w-[250px] md:hidden  lg:block'/>
