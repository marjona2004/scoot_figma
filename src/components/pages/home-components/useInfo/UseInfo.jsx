...
export const UseInfo = () => {
  return (
    ...
    <div className='container '>
      ...
      <div className='lg:flex lg:gap-[60px] lg:flex-row  md:flex  md:flex-col-reverse    '>
        <div className='lg:py-[50px]  md:mb-[10px]'>
            <h2 className='text-[48px] font-bold leading-12 text-[#495567] md:text-center lg:text-start' >Easy to use <br />
             riding telemetry
           </h2>
           <p className='mb-[40px] mt-[24px] text-[#939CAA] text-[15px] leading-6 font-normal md:text-center lg:text-start' >
        ...
        <div>
         <img src={useInfo_img} alt=""className='' />
        </div>
      </div>

      <div className=' my-[150px]  lg:flex lg:justify-between'>
        <div>
         <img src={useInfo_img_two} alt="" className='md:ml-[150px] lg:ml-0'/>
        </div>
        <div className='py-[50px] '>
            <h2 className='text-[48px] font-bold leading-12 text-[#495567] md:text-center lg:text-start' >
      ...
      <div className='lg:flex-row lg:justify-between mb-[178px] md:flex md:flex-col-reverse '>
        <div className='py-[50px]'>
            <h2 className='text-[48px] font-bold leading-12 text-[#495567] md:text-center lg:text-start' >
        ...
        <div >
         <img src={useInfo_img_three} alt=""  className='rounded-[50%] md:ml-[150px] lg:ml-0' />
        </div>
      </div>
    
    </div>
    <img src={useInfo_round}  alt="" className='absolute top-[30px] right-0' />
    <img src={useInfo_round}  alt="" className='absolute bottom-[10px] right-0 md:bottom-[450px] lg:bottom-0' />
    ...
    <img src={useInfo_line_three} alt=""  className='absolute bottom-[200px] right-0 lg:w-[450px] md:bottom-[720px] md:w-[400px]  lg:bottom-[200px]'/>
